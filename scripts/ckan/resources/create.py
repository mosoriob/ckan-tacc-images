...
def create_resource(dataset_name: str, resource_data: Dict, api_key: str, ckan_url: str) -> Optional[Dict]:
...
def main():
    ...
    for resource_data in resources:
        ...
        if validate_resource(resource_data):
            resource = create_resource(args.dataset_name, resource_data, args.api_key, args.ckan_url)
            if resource:
                success_count += 1
